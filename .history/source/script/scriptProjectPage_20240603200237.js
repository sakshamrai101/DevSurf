...
function updateProgress(milestoneId) {
    ...
    const timelineTotal = document.getElementsById('timeline-elements');
    const completedItems = timelineTotal.querySelectorAll('.completed');
    const uncompletedItems = timelineTotal.querySelectorAll('.uncompleted');
