...
function addMilestone() {
    ...
    newMilestone.innerHTML = `
        <div contenteditable="true" class="milestone-name" onclick="toggleTasks(${milestoneCount});">Milestone ${milestoneCount}</div>
...
document.addEventListener("DOMContentLoaded", function () {
    // Function to handle deleting a milestone
    function deleteMilestone(milestoneElement) {
        const milestoneId = milestoneElement.closest('li').getAttribute('data-id');
        milestoneElement.closest('li').remove();
    ...
    // Add double-click event listener to all existing milestone elements
    const milestoneElements = document.querySelectorAll('.milestone-name');
    milestoneElements.forEach(milestone => {
        milestone.addEventListener('dblclick', function () {
