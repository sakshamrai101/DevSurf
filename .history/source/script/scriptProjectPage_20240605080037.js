...
function updateTimelineProgress() {
    ...
    if(completedMI == timelineLength-2) {
        ...
        timelineComp[timelineLength].classList.remove('uncompleted');
        timelineComp[timelineLengthr].classList.add('completed');
    }
    else {
        tlProgress = completedMI/timelineLength * currentWidth;
        tlProgress = tlProgress.toFixed(2);
        timelineComp[timelineLength].classList.remove('completed');
        timelineComp[timelineLength].classList.add('uncompleted');
    }
