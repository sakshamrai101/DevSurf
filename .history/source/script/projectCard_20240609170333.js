class ProjectCard extends HTMLElement {
    ...
    connectedCallback() {
        this.setAttribute('data-index', this.index); // Store index in an attribute
        this.render();
    }
    ...
    render() {
        ...
        saveButton.addEventListener('click', () => {
            ...
            localStorage.setItem(`project-${this.index}`, JSON.stringify(projectData));
            document.querySelector('stats-graph').updateChart();
            saveProjectCards();
        });

        trashButton.addEventListener('click', () => {
            localStorage.removeItem(`project-${this.index}`);
            this.remove();
            document.querySelector('stats-graph').updateChart();
            saveProjectCards();
        });
