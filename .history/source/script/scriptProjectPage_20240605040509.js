...
function addMilestone(milestoneName) {
    ...
    let milestoneArray = Array.from(milestones);
    saveMilestoneToStorage(console.log(ulArray););
}
/**
 ...
 * 
 * @param {HTMLElement} milestone array
 */

function saveMilestoneToStorage (milestones) {
    let milestoneNames = [];
