...
function updateProgress(milestoneId) {
    ...
    let totalNumber = timelineTotal.length;
    const line = document.getElementById('line');
    let progressCompleted = (completedNumber/totalNumber) * 100;
    line.style.background = 'linear-gradient(to right, #ff0000 20%, #00ff00 20%, #00ff00 80%, #0000ff 80%)';
    console.log('hello');
}
