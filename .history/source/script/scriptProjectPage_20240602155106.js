...
function updateProgress(milestoneId) {
    ...
    const milestoneData = document.getElementById(milestoneId).getAttribute('data-id');
    const timelineElement = document.querySelector(`#timeline-elements [data-id="${milestoneData}"]`);
    ...
    if(progressPercentage == 100) {
        if (timelineElement) {
            if (milestone.classList.contains('uncompleted')) {
