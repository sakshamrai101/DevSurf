...
/**
 * Finds the Percentage of tasks completed 
 * 
...
function updateProgress(milestoneId) {
    ...
    let progressPercentage = getProgressPercentage(milestoneId);
...
function updateTimelineProgress() {
    const milestoneList = document.getElementById('milestone-list');
    const milestones = milestoneList.querySelectorAll('li');
    ...
    const taskList = document.getElementById(`task-list${milestoneId}`);
    //get the percentage of tasklists
    ...
    if(completedMI == timelineLength - 2) {
        ...
        tlProgress = maxMilestone/(timelineLength - 1) * currentWidth;
